...
label chapter6:
    ...
    ms_iva "Binuksan ko ang batas. Walang ganoon na provision."
    narrator "(Tahimik. Ang hallway ay biglang napakalayo.)"
    ...
    menu:
        "Totoo po, Ma'am. Hindi ko nabasa ang aktwal na batas. Kinopya ko ang AI output.":
            ...
            if player_gender == "male":
                ...
                mc_f "Hindi ko po bina-verify. Kinopya ko ang output ng AI nang hindi nag-check. Mali ako, Ma'am."
            ...
            narrator "(Lumakad siya. Nanatili ka sa hallway nang isang minuto.)"
            narrator "(Mahirap ang panahon — pero buo.)"
        ...
        "N-Nabasa ko po, Ma'am. Baka nagkamali lang ng pag-cite.":
            ...
            narrator "(Hindi ka sumasagot. Wala ka nang masasagot.)"
